// --- DATOS DEL MENÚ (Principales) ---
let questions = [
  {
    id: 1,
    title: "Principal 1",
    desc: "Capas infinitas de documentos, PDFs que nadie revisa y una salsa secreta llamada '¿Pero dónde guardé este archivo?'.",
    // Imagen: Lasaña
    img: "images/principales/lasaña.jpg",
    realDish: "Lasaña de Gestión Avanzada de la Información",
    realDesc:
      "Capas infinitas de documentos, PDFs que nadie revisa y una salsa secreta llamada '¿Pero dónde guardé este archivo?'.",
    options: [
      { text: "Estofado de Gestión Financiera", correct: false },
      { text: "Lasaña de Gestión Avanzada de la Información", correct: true },
      { text: "Linguini de Lenguaje de Marcas", correct: false },
  ...
  },
  {
    id: 2,
    title: "Principal 2",
    desc: "Cocción lenta de presupuestos, gastos y previsiones, servido con aroma a 'este Excel pide clemencia'.",
    // Imagen: Estofado
    img: "images/principales/estofado.jpg",
    realDish: "Estofado de Gestión Financiera",
    realDesc:
      "Cocción lenta de presupuestos, gastos y previsiones, servido con aroma a 'este Excel pide clemencia'.",
    options: [
      { text: "Estofado de Gestión Financiera", correct: true },
      { text: "Lasaña de Gestión Avanzada de la Información", correct: false },
      { text: "Linguini de Lenguaje de Marcas", correct: false },
      { text: "Tarta Lingüística de Francés e Inglés", correct: false },
    ],
  },
  {
    id: 3,
    title: "Principal 3",
    desc: "Tiras de etiquetas perfectamente ordenadas, con un aliño suave de HTML que se rompe por un cierre mal puesto.",
    // Imagen: Linguini (Pasta)
    img: "images/principales/linguini.jpg",
    realDish: "Linguini de Lenguaje de Marcas",
    realDesc:
      "Tiras de etiquetas perfectamente ordenadas, con un aliño suave de HTML que se rompe por un cierre mal puesto.",
    options: [
      { text: "Estofado de Gestión Financiera", correct: false },
      { text: "Lasaña de Gestión Avanzada de la Información", correct: false },
      { text: "Linguini de Lenguaje de Marcas", correct: true },
      { text: "Tarta Lingüística de Francés e Inglés", correct: false },
    ],
  },
];
