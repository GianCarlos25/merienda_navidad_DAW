// --- DATOS DEL MENÚ ---
// "realDish": Nombre oficial del plato
// "realDesc": Descripción oficial del plato (subtexto)
let questions = [
  {
    id: 1,
    title: "Entrante 1",
    desc: "Perfectamente alineada, distancia entre hojas medida con regla. Incluye: saludo oficial, orden de precedencias y cero alimentos reales.",
    // Imagen: Alcachofas con anchoa
    img: "images/entrantes/ensaladaProtocolo.jpg",
    realDish: "Ensalada de Protocolo con Etiqueta al Punto",
    realDesc:
    ...
    options: [
      { text: "Lasaña de Gestión Avanzada", correct: false },
      { text: "Ensalada de Protocolo con Etiqueta al Punto", correct: true },
      { text: "Pincho de Contabilidad", correct: false },
      { text: "Pincho de Organización de Eventos", correct: false },
    ],
  },
  {
    id: 2,
    title: "Entrante 2",
    desc: "Planificado, calendarizado, enviado por email, aprobado por tres departamentos… y cancelado a última hora como todo buen evento.",
    // Imagen: Tosta de foie
    img: "images/entrantes/pinchoOrganizacion.jpg",
    realDish: "Pincho de Organización de Eventos Empresariales",
    realDesc:
    ...
    options: [
      { text: "Lasaña de Gestión Avanzada", correct: false },
      { text: "Ensalada de Protocolo", correct: true },
      { text: "Pincho de Contabilidad", correct: false },
      {
        text: "Pincho de Organización de Eventos Empresariales",
        correct: true,
      },
    ],
  },
  {
    id: 3,
    title: "Entrante 3",
    desc: "Crujiente mezcla de asientos, balances y ese sabor clásico a “¿Por qué no me cuadra un céntimo?”",
    // Imagen: Croquetas
    img: "images/entrantes/pinchoContabilidad.jpg",
    realDish: "Pincho de Contabilidad",
    realDesc:
      "Crujiente mezcla de asientos, balances y ese sabor clásico a “¿Por qué no me cuadra un céntimo?”",
    options: [
      { text: "Lasaña de Gestión Avanzada", correct: false },
      { text: "Ensalada de Protocolo", correct: false },
      { text: "Pincho de Contabilidad", correct: true },
      { text: "Pincho de Organización de Eventos", correct: false },
    ],
  },
];
